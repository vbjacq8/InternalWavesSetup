...
* //Place the whiteboard comment for BOS right after the shadowgraph
* //Add two cartoons, one of BOS setup and one of the Shadowgraph setup.
...
* For BOS, a whiteboard is then placed on the opposite side of the cameras, parallel with the tank (for reference we place it 280 cm away from the tank.)
